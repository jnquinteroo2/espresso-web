...
- **destructive-foreground** (3 connections) — `.claude/skills/design-system/templates/design-tokens-starter.json`
...
- [design-system Skill (bundled tool)](design-system_Skill_%28bundled_tool%29.md) (1 shared connections)
